...
if __name__ == '__main__':
    ...
    while True:
        ...
        if "open music" in query:
            musicPath = r"C:\Users\ACER\Downloads\100-badtameez-dil-www-djtargaon-in-7892 - Copy.mp3"
            os.startfile(musicPath)

        elif "the time" in query:
            musicPath = r"C:\Users\ACER\Downloads\keirooooo-instrumental-60297 - Copy.mp3"
